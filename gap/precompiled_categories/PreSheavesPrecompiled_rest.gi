...
function ( cat_1, source_1, alpha_1, beta_1, range_1 )
    ...
    hoisted_46_1 := Concatenation( List( deduped_101_1, function ( logic_new_func_x_2 )
              ...
              deduped_18_2 := hoisted_42_1[logic_new_func_x_2];
              deduped_17_2 := hoisted_44_1[logic_new_func_x_2];
              deduped_16_2 := hoisted_30_1[logic_new_func_x_2];
              ...
              hoisted_10_2 := hoisted_45_1[logic_new_func_x_2];
              ...
              hoisted_11_2 := hoisted_35_1[deduped_14_2];
              hoisted_4_2 := hoisted_43_1[logic_new_func_x_2];
              ...
              hoisted_6_2 := hoisted_35_1[deduped_13_2];
              return [ List( [ 1 .. hoisted_41_1[deduped_13_2] ], function ( i_3 )
                          return hoisted_7_2[hoisted_6_2[i_3]];
                      end ), List( [ 1 .. hoisted_41_1[deduped_14_2] ], function ( i_3 )
    ...
    hoisted_47_1 := List( deduped_88_1, function ( i_2 )
            return 1 + Sum( hoisted_15_1, function ( j_3 )
                      return (hoisted_46_1[j_3][i_2] - 1) * hoisted_38_1[j_3];
                  end );
        end );
    ...
    hoisted_39_1 := List( deduped_88_1, function ( i_2 )
            return 1 + Sum( hoisted_15_1, function ( j_3 )
                      return (hoisted_36_1[j_3][i_2] - 1) * hoisted_38_1[j_3];
                  end );
        end );
    deduped_82_1 := Filtered( [ 1 .. Length( deduped_88_1 ) ], function ( x_2 )
            return hoisted_39_1[x_2] = hoisted_47_1[x_2];
        end );
    ...
    deduped_81_1 := Filtered( [ 1 .. Length( deduped_87_1 ) ], function ( x_2 )
    ...
    hoisted_50_1 := List( deduped_100_1, function ( logic_new_func_x_2 )
            ...
            return List( hoisted_49_1, function ( i_3 )
                    return hoisted_3_2[hoisted_48_1[i_3]];
                end );
        end );
    hoisted_76_1 := List( deduped_78_1, function ( i_2 )
            return 1 + Sum( hoisted_54_1, function ( j_3 )
                      return (hoisted_50_1[j_3][i_2] - 1) * hoisted_53_1[j_3];
                  end );
        end );
    ...
    hoisted_74_1 := List( deduped_92_1, function ( i_2 )
            return 1 + Sum( hoisted_54_1, function ( j_3 )
                      return (hoisted_65_1[j_3][i_2] - 1) * hoisted_67_1[j_3];
                  end );
        end );
    ...
    hoisted_70_1 := List( deduped_100_1, function ( logic_new_func_x_2 )
            ...
            return List( hoisted_69_1, function ( i_3 )
                    return hoisted_3_2[hoisted_68_1[i_3]];
                end );
        end );
    hoisted_73_1 := List( deduped_77_1, function ( i_2 )
            return 1 + Sum( hoisted_54_1, function ( j_3 )
                      return (hoisted_70_1[j_3][i_2] - 1) * hoisted_72_1[j_3];
                  end );
        end );
    hoisted_75_1 := List( deduped_77_1, function ( i_2 )
            return hoisted_74_1[hoisted_73_1[i_2]];
        end );
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
              ...
              return Position( hoisted_76_1, hoisted_75_1[x_2] );
          end ) );
end
########
...
function ( cat_1, arg2_1, arg3_1, arg4_1 )
    ...
    hoisted_30_1 := Concatenation( List( deduped_47_1, function ( logic_new_func_x_2 )
              ...
              deduped_16_2 := hoisted_7_1[logic_new_func_x_2];
    ...
    deduped_38_1 := Filtered( [ 1 .. Length( deduped_41_1 ) ], function ( x_2 )
    ...
    hoisted_36_1 := List( deduped_46_1, function ( logic_new_func_x_2 )
            ...
            hoisted_4_2 := List( hoisted_33_1, function ( i_3 )
                    return hoisted_3_2[hoisted_32_1[i_3]];
                end );
            return List( hoisted_35_1, function ( i_3 )
                    return hoisted_4_2[hoisted_34_1[i_3]];
                end );
        end );
    ...
    return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
              ...
              deduped_16_2 := hoisted_6_1[i_2];
              deduped_15_2 := hoisted_3_1[i_2];
              ...
              hoisted_9_2 := List( deduped_13_2, function ( i_3 )
                      return 1 + Sum( hoisted_37_1, function ( j_4 )
              ...
              return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                     ), hoisted_9_1, hoisted_1_1[i_2], hoisted_2_1[i_2], AsList, List( [ 1 .. deduped_15_2 ], function ( i_3 )
...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_39_1 := Filtered( [ 1 .. Length( deduped_42_1 ) ], function ( x_2 )
            return hoisted_16_1[x_2] = hoisted_27_1[x_2];
        end );
    ...
    return List( deduped_37_1, function ( i_2 )
            ...
            hoisted_5_2 := List( hoisted_33_1, function ( logic_new_func_x_3 )
                    ...
                    hoisted_3_3 := List( hoisted_8_1, function ( i_4 )
                            return 1 + REM_INT( QUO_INT( i_4, hoisted_1_3 ), hoisted_2_3 );
                        end );
                    hoisted_4_3 := List( hoisted_35_1, function ( i_4 )
                            return hoisted_3_3[hoisted_34_1[i_4]];
                        end );
                    return List( hoisted_4_2, function ( i_4 )
                            return hoisted_4_3[hoisted_3_2[i_4]];
                        end );
                end );
            ...
            return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                      ...
                      local hoisted_1_3, hoisted_2_3, hoisted_3_3, hoisted_4_3, hoisted_5_3, hoisted_6_3, hoisted_7_3, hoisted_8_3, hoisted_9_3, hoisted_10_3, hoisted_11_3, deduped_12_3, deduped_13_3, deduped_14_3, deduped_15_3, deduped_16_3, deduped_17_3;
                      deduped_17_3 := hoisted_2_2[i_3];
                      deduped_16_3 := hoisted_1_1[i_3];
                      deduped_15_3 := hoisted_2_1[i_3];
                      deduped_14_3 := Product( [ deduped_17_3, deduped_15_3 ] );
                      deduped_13_3 := [ 1 .. deduped_14_3 ];
                      deduped_12_3 := [ 0 .. deduped_14_3 - 1 ];
                      hoisted_2_3 := deduped_16_3;
                      hoisted_1_3 := deduped_15_3;
                      hoisted_10_3 := List( [ 0 .. Product( [ deduped_16_3 ^ deduped_15_3, deduped_15_3 ] ) - 1 ], function ( i_4 )
                              return 1 + REM_INT( QUO_INT( QUO_INT( i_4, hoisted_1_3 ), hoisted_2_3 ^ (hoisted_1_3 - REM_INT( i_4, hoisted_1_3 ) - 1) ), hoisted_2_3 );
                          end );
                      hoisted_8_3 := [ deduped_15_3, 1 ];
                      hoisted_6_3 := List( deduped_12_3, function ( i_4 )
                              return 1 + REM_INT( i_4, hoisted_1_3 );
                          end );
                      hoisted_5_3 := hoisted_5_2[i_3];
                      hoisted_3_3 := deduped_17_3;
                      hoisted_4_3 := List( deduped_12_3, function ( i_4 )
                              return 1 + REM_INT( QUO_INT( i_4, hoisted_1_3 ), hoisted_3_3 );
                          end );
                      hoisted_7_3 := [ List( deduped_13_3, function ( i_4 )
                                  return hoisted_5_3[hoisted_4_3[i_4]];
                              end ), List( deduped_13_3, function ( i_4 )
                                  return hoisted_6_3[i_4];
                              end ) ];
                      hoisted_9_3 := List( deduped_13_3, function ( i_4 )
                              return 1 + Sum( hoisted_36_1, function ( j_5 )
                                        return (hoisted_7_3[j_5][i_4] - 1) * hoisted_8_3[j_5];
                                    end );
                          end );
                      hoisted_11_3 := List( deduped_13_3, function ( i_4 )
                              return hoisted_10_3[hoisted_9_3[i_4]];
                          end );
                      return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                             ), hoisted_5_1, hoisted_28_1[i_3], hoisted_29_1[i_3], AsList, List( [ 1 .. deduped_15_3 ], function ( i_4 )
                                return hoisted_11_3[i_4];
                            end ) );
                  end ) );
        end );
end
