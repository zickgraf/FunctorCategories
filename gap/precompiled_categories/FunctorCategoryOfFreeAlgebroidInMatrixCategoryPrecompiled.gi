...
function ( cat_1, arg2_1, arg3_1 )
    ...
    deduped_13_1 := ValuesOnAllObjects( arg3_1 );
    deduped_12_1 := ValuesOnAllObjects( arg2_1 );
    deduped_11_1 := Range( cat_1 );
    deduped_10_1 := Source( cat_1 );
    deduped_9_1 := SetOfObjects( deduped_10_1 );
    hoisted_8_1 := FunctorMorphismOperation( UnderlyingCapTwoCategoryCell( cat_1, arg3_1 ) );
    hoisted_7_1 := deduped_13_1;
    hoisted_6_1 := FunctorMorphismOperation( UnderlyingCapTwoCategoryCell( cat_1, arg2_1 ) );
    hoisted_5_1 := deduped_12_1;
    hoisted_4_1 := deduped_11_1;
    hoisted_3_1 := List( deduped_13_1, Dimension );
    hoisted_2_1 := List( deduped_12_1, Dimension );
    hoisted_1_1 := deduped_9_1;
    return ObjectifyObjectForCAPWithAttributes( rec(
           ), cat_1, Source, deduped_10_1, Range, deduped_11_1, ValuesOnAllObjects, LazyArray( deduped_9_1, function ( objB_2 )
              local deduped_1_2;
              deduped_1_2 := SafePosition( hoisted_1_1, objB_2 );
              return ObjectifyObjectForCAPWithAttributes( rec(
                     ), hoisted_4_1, Dimension, hoisted_2_1[deduped_1_2] * hoisted_3_1[deduped_1_2] );
          end ), ValuesOnAllGeneratingMorphisms, LazyArray( SetOfGeneratingMorphisms( deduped_10_1 ), function ( morB_2 )
              local morphism_attr_1_2, deduped_2_2, deduped_3_2;
              deduped_3_2 := SafePosition( hoisted_1_1, Range( morB_2 ) );
              deduped_2_2 := SafePosition( hoisted_1_1, Source( morB_2 ) );
              morphism_attr_1_2 := KroneckerMat( UnderlyingMatrix( hoisted_6_1( hoisted_5_1[deduped_2_2], morB_2, hoisted_5_1[deduped_3_2] ) ), UnderlyingMatrix( hoisted_8_1( hoisted_7_1[deduped_2_2], morB_2, hoisted_7_1[deduped_3_2] ) ) );
              return ObjectifyMorphismWithSourceAndRangeForCAPWithAttributes( rec(
                     ), hoisted_4_1, ObjectifyObjectForCAPWithAttributes( rec(
                       ), hoisted_4_1, Dimension, NumberRows( morphism_attr_1_2 ) ), ObjectifyObjectForCAPWithAttributes( rec(
                       ), hoisted_4_1, Dimension, NumberColumns( morphism_attr_1_2 ) ), UnderlyingMatrix, morphism_attr_1_2 );
